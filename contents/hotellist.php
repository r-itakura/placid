...
<form id="frmHotelList" action="<?php print($_SERVER['PHP_SELF']) ?>" method="post">
    ...
    <div id="divContents">
    	<div id="divContentsMain">
        	<div id="divImgNightView">
                <div id="divTitleBack">
                	<div id="divTitle">
                    	<img src="../images/lblHotelList.png" alt="ホテル一覧" width="104" height="21">
                    </div>
                </div>
            </div>
            <hr />
            <div id="divImgOte">
            	<img src="../images/imgOtemachi.png" alt="大手町" width="794" height="452">
            </div>
            <div id="divImgKudan">
            	<img src="../images/imgKudanshita.png" alt="九段下" width="794" height="452">
            </div>
        </div>
    </div>
    <div id="divFooter">
